...
public class SecondIntroFragment extends Fragment {
    ...
    private void initializeViews() {
        ...
        skip = (TextView)view.findViewById(R.id.textViewSecondIntroSkip);
        next = (TextView)view.findViewById(R.id.textViewSecondIntroNext);
        back = (ImageView)view.findViewById(R.id.imageViewSecondIntroBack);
    ...
    private void activateListeners() {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                fragmentTransaction.replace(R.id.mainFragment,new FirstIntroFragment());
                fragmentTransaction.commit();
